        ...
        <div className="legal-container">
          ...
          <div className="legal-content">
            ...
            <ul>
              ...
              <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to BlendDocs.</li>
              ...
              <li><strong>Website</strong> refers to BlendDocs, accessible from <a href="https://blend-docs.com" target="_blank" rel="noopener noreferrer">blend-docs.com</a></li>
            ...
            <ul>
              ...
              <li>
                ...
                <p>Type: Persistent Cookies</p>
                <p>Administered by: Us</p>
                <p>Purpose: These Cookies allow us to remember choices You make when You use the Website.</p>
              </li>
            </ul>
            ...
            <ul>
              ...
              <li><strong>To contact You:</strong> To contact You by email regarding updates or informative communications related to the functionalities.</li>
