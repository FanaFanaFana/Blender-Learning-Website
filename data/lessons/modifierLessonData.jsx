export const modifierLessonData = {
 ...
 heroConfig : {
  ...
  // 👇 Complete modifier data with all major modifiers
   modifierCategories : [
    {
      ...
      modifiers: [
        ...
        },
        {
          ...
          detailedInfo: {
            overview: 'The Build modifier makes faces appear or disappear over time. Great for creating animated ruction sequences or dissolving effects.',
            pages: [
              {
   ...
   practiceProjects: [
  { 
    title: 'Create a Detailed Gear with Array Modifier', 
    desc: 'Build a mechanical gear using Array and Mirror modifiers',
    duration: '15 min', 
    difficulty: 'Beginner',
    skills: ['Array Modifier', 'Mirror Modifier', 'Basic Modeling']
  },
  { 
    title: 'Build a Symmetrical Character Head', 
    desc: 'Model a character head using Mirror and Subdivision Surface',
    duration: '25 min', 
    difficulty: 'Intermediate',
    skills: ['Mirror Modifier', 'Subdivision Surface', 'Character Modeling']
  },
  { 
    title: 'Design a Cloth Simulation Scene', 
    desc: 'Create a realistic cloth falling onto objects with physics',
    duration: '30 min', 
    difficulty: 'Advanced',
    skills: ['Cloth Simulation', 'Collision', 'Physics Settings']
  }
]
}