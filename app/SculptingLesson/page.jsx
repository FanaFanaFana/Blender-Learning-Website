          ...
          <section style={{ padding: '4rem 0' }}>
            <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 2rem' }}>
              <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
                <SectionHeader 
                  title="What is Digital Sculpting?"
                  description="Sculpting in Blender is an intuitive way to create organic forms and detailed surfaces. Instead of manipulating individual vertices, you paint directly on the surface with various brushes, just like working with real clay."
                  color={themeColor}
                />
          ...
          <section style={{ padding: '4rem 0' }}>
            <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 2rem' }}>
              ...
              <p style={{ textAlign: 'center', color: '#8fa9bd', fontSize: '1.25rem', marginBottom: '3rem' }}>
                Master these essential brushes to bring your sculptures to life
              </p>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' }}>
                      {category.brushes.map((brush, brushIdx) => (
                        <ClickableCard
                          ...
                          onClick={() => {
                            setSelectedBrush({ ...brush, color: category.color })
                            setCurrentPage(0)
                          }}
                        />
                      ))}
        ...
        {activeTab === 'techniques' && (
          <section style={{ padding: '4rem 0' }}>
            <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 2rem' }}>
              ...
              <p style={{ textAlign: 'center', color: '#8fa9bd', fontSize: '1.25rem', marginBottom: '3rem' }}>
                Essential workflows and methods for efficient sculpting
              </p>
              ...
              <div style={{ display: 'grid', gap: '3rem' }}>
                {techniques.map((category, idx) => (
                  <div key={idx}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' }}>
                      {category.items.map((technique, techIdx) => (
                        <ClickableCard
                          key={techIdx}
                          item={technique}
                          color={category.color}
                          onClick={() => {
                            setSelectedBrush({ ...technique, color: category.color })
                            setCurrentPage(0)
                          }}
                        />
                      ))}
        ...
        {activeTab === 'practice' && (
          <section style={{ padding: '4rem 0' }}>
            <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 2rem' }}>
              ...
              <p style={{ textAlign: 'center', color: '#8fa9bd', fontSize: '1.25rem', marginBottom: '3rem' }}>
                Apply your sculpting skills with these progressive exercises
              </p>
                  ...
                  <div key={index} style={{ background: 'rgba(21, 35, 47, 0.6)', padding: '2rem', borderRadius: '16px', border: '1px solid rgba(255, 255, 255, 0.05)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '2rem' }}>
                      ...
                      <div>
                        ...
                        <p style={{ color: '#8fa9bd', margin: 0, marginBottom: '0.5rem' }}>{project.desc}</p>
...
// ============================================
// 💡 Complete Sculpting Lesson Pattern:
// - 4 tabs: Overview, Brushes, Techniques, Practice
// - 20+ brushes organized in 4 categories
// - 6 essential techniques
// - 4 progressive practice projects
// - Pink/orange gradient theme
// - All using existing icons and components
// ============================================