...
export default function ProductDesignLesson() {
  ...
  const tabs = [
    ...
    { id: 'principles', icon: '/Icons/mesh_icosphere.svg', label: 'Design Principles' },
          ...
          detailedInfo: {
            ...
            pages: [
              ...
              },
              {
                ...
                content: 'Look at disassembly images to understand construction. See how parts fit together, material transitions, internal structure. Informs realistic design.',
            ...
            <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 2rem' }}>
              <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
                <SectionHeader 
                  ...
                  description="Learn to create beautiful, photorealistic consumer products. Master the intersection of form, function, and materials for premium product visualization."
                  color={themeColor}
                />
          ...
          <section style={{ padding: '4rem 0' }}>
            <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 2rem' }}>
              ...
              <p style={{ textAlign: 'center', color: '#8fa9bd', fontSize: '1.25rem', marginBottom: '3rem' }}>
                Core concepts for creating professional product designs
              </p>

              <div style={{ display: 'grid', gap: '3rem' }}>
                {designPrinciples.map((category, idx) => (
                  <div key={idx}>
        ...
        {activeTab === 'techniques' && (
          <section style={{ padding: '4rem 0' }}>
            <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 2rem' }}>
              ...
              <p style={{ textAlign: 'center', color: '#8fa9bd', fontSize: '1.25rem', marginBottom: '3rem' }}>
                Essential methods for product design creation
              </p>
        ...
        {activeTab === 'workflow' && (
          <section style={{ padding: '4rem 0' }}>
            <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 2rem' }}>
              ...
              <p style={{ textAlign: 'center', color: '#8fa9bd', fontSize: '1.25rem', marginBottom: '3rem' }}>
                Professional workflow from concept to photorealistic render
              </p>
        ...
        {activeTab === 'practice' && (
          <section style={{ padding: '4rem 0' }}>
            <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 2rem' }}>
              ...
              <p style={{ textAlign: 'center', color: '#8fa9bd', fontSize: '1.25rem', marginBottom: '3rem' }}>
                Build your product design skills with these focused exercises
              </p>
